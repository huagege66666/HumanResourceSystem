				...
				<div class="widget widget-table">
					...
					<div class="widget-content">
						...
						<table class="table table-striped table-bordered">
							...
							<tbody>
							  <s:iterator value="humresList" status="state">
							    <tr>
									<td><s:property value="ename"/></td>
									<td><s:property value="sex"/></td>
									<td><s:property value="recschool"/></td>
									<td><s:property value="school"/></td>
									<td><s:property value="major"/></td>
									<td class="action-td">
										<a href="${pageContext.request.contextPath}/tohumanres?humid=<s:property value="resid"/>" class="btn btn-small btn-warning">
												<i class="icon-ok"></i>								
										</a>
									</td>
								</tr>
					...
					<%-- <div style="float :right">
						<a href="${pageContext.request.contextPath}/tohumanlist?pageNo=${prev}" class="btn btn-small">
							<i>上一页</i>
						</a>
						<a href="${pageContext.request.contextPath}/tohumanlist?pageNo=${next}" class="btn btn-small">
							<i>下一页</i>
						</a>
					</div> --%>
...
<script type="text/javascript">
		function form_submit(pageNo){
	  		$("#form_table").attr("action","${pageContext.request.contextPath}/tohumanlist?pageNo="+pageNo);
	  		$("#form_table").submit();
		}
