					...
					<div class="span9">
						...
						<br />
							<div class="tab-content">
								...
								<form action="fireemp" class="form-horizontal" method="post" />
									<fieldset>
										...
										<div class="control-group">
											...
											<div class="controls">
												<s:textarea name="leavejob.direction"></s:textarea>
											</div> <!-- /controls -->
										</div>
										<div class="form-actions">
											<button type="submit" class="btn btn-primary">离职</button> 
										</div> <!-- /form-actions -->
									</fieldset>
								</form>
								</div>
